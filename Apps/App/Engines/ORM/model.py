...
from sqlalchemy import Integer, String, Float, Boolean, Date, SmallInteger, Numeric, DateTime, Binary, Unicode, PickleType, Text  #importamos los tipos de datos de las tablas
...
class Libro_row(Libro):
    def __init__(self, libro_id, titulo, autor, editorial, genero, contenido, portada):
